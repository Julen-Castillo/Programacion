 ...
 * @author 1gdaw03
 */
public class AltaCaso extends javax.swing.JFrame {

    /**
     * Creates new form AltaCaso
     */
    public AltaCaso() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaCaso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
