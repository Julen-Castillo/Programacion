...
private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
         ...
         Matcher m = patron.matcher(tfNombre.getText());
                ...
                Pattern patron2 = Pattern.compile("^[A-Z][a-z]+ $");
                Matcher m2 = patron2.matcher(tfApellidos.getText());
                if (m.matches()){
                    
                        JOptionPane.showMessageDialog(null, "El apellido está mal escrito");             
                } 
                else {
                ...
                if (resultado = true){
                 limpiarVentana();
                    ...
                    JOptionPane.showMessageDialog(null, "Algun dato que has introducido no es correcto");
